...
| --- | --- | --- | --- | --- | --- | --- |
| `quranenc:amharic_zain` | Amharic (`am`, `amh`), Ethiopic, LTR | Muhammad Zain Zahruddin; Africa Academy; publisher: Africa Academy | Approved candidate; registry disabled; available in the Ayah Study Lens only after verified pack activation | `1.0.1`; `1.0.1-xml.1`; published 2024-06-11; updated 2026-01-20 | 114 surahs, 6,236 ayat; no missing, duplicate, empty, invalid, or wrong-script records | QuranEnc permits download and republication under its conditions; explicit verified installation is supported by `app/translation-packs.mjs` |
