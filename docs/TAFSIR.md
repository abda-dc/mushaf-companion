...
The Ayah Study Lens also exposes this exact document and normalized block model in its Tafsir tab. The standalone tafsir panel, resource 169 identity, source revision, normalization, attribution, and checksum verification remain unchanged. The Lens does not translate tafsir.
